...
class MahasiswaController extends Controller
{
    ...
    {
        return view('mahasiswa.create'); //tanda (.) merujuk ke folder/ file
    }

    public function show(Mahasiswa $mahasiswa)  //route model binding
    {
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mahasiswas.index')->with(
            'pesan',
